export const translations = {
    uk: {
        adminUsers: {
            ...
            blockEmailSent: 'Email користувачу надіслано.',
            blockEmailFailed: 'Користувача заблоковано, але email не надіслано',
            blockEmailPending: 'Користувача заблоковано. Результат відправлення email буде записано в профілі.',
        ...
        account: {
            ...
            auth: {
                ...
                passwordResetSent: 'Якщо акаунт існує, ми надіслали лист для відновлення пароля. Перевірте також папку Spam / Спам.',
        ...
        authorCard: {
            ...
            write: 'Написати',
            leaveReview: 'Залишити карму',
            openReviews: 'Відкрити відгуки',
            hideReviews: 'Сховати відгуки',
        ...
        userPage: {
            ...
            backToAd: 'Назад до оголошення',
            reviews: 'Відгуки',
            reputation: 'Репутація',
            noReviews: 'Поки немає відгуків',
            reviewKarma: 'карма',
            chatError: 'Не вдалося відкрити чат. Спробуйте ще раз.',
            joined: 'На сайті з',
    ...
    pl: {
        adminUsers: {
            ...
            blockEmailSent: 'Email do użytkownika został wysłany.',
            blockEmailFailed: 'Użytkownik został zablokowany, ale email nie został wysłany',
            blockEmailPending: 'Użytkownik został zablokowany. Wynik wysyłki email zostanie zapisany w profilu.',
        ...
        account: {
            ...
            auth: {
                ...
                passwordResetSent: 'Jeśli konto istnieje, wysłaliśmy wiadomość do resetowania hasła. Sprawdź także folder Spam.',
        ...
        authorCard: {
            ...
            write: 'Napisz',
            leaveReview: 'Wystaw karmę',
            openReviews: 'Otwórz opinie',
        ...
        userPage: {
            ...
            backToAd: 'Wróć do ogłoszenia',
            reviews: 'Opinie',
            reputation: 'Reputacja',
            noReviews: 'Brak opinii',
            reviewKarma: 'karma',
            chatError: 'Nie udało się otworzyć czatu. Spróbuj ponownie.',
